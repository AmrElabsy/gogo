...
<div class="row">
	<div class="col-md-7" style="padding: 0;">
		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-body">
					<h4 class="header-title"><p><?php echo get_phrase('setup_tap_settings'); ?></p></h4>
					<form class="" action="<?php echo site_url('admin/payment_settings/tap_settings'); ?>" method="post" enctype="multipart/form-data">
						<div class="form-group">
							<label><?php echo get_phrase('tap_currency'); ?></label>
							<select class="form-control select2" data-toggle="select2" id="tap_currency" name="tap_currency" required>
	...
	<div class="col-md-5">
		<div class="alert alert-info" role="alert">
			...
			<p><?php echo get_phrase('please_make_sure_that') . ' "' . get_phrase('system_currency') . '", ' . '"' . get_phrase('paypal_currency') . '" and ' . '"' . get_phrase('stripe_currency') . '" ' . get_phrase('are_same'); ?>
				.</p>
		</div>
	</div>
</div>
